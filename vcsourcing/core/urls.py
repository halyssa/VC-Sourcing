...
from .views import health, CompanyListView, CompanyDetailView, llm_test, UserWatchlistView, watchlist_add, watchlist_remove, company_summary, recommended_companies
from .auth_views import login, logout, me

urlpatterns = [
    path("api/health/", health, name="health"),
    path("api/companies/", CompanyListView.as_view(), name="company-list"),
    path("api/companies/recommended/", recommended_companies, name="recommended-companies"),
    path("api/companies/<int:pk>/", CompanyDetailView.as_view(), name="company-detail"),
    path("api/companies/<int:pk>/summary/", company_summary, name="company-summary"),
